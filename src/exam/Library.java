...
public class Library {
	...
	private List<Readable> items = new LinkedList <> ();
	private String name;
	...
	public void addItem (Readable r) {
		items.add(r);
	}
	...
	public int getNumArticles () {
		int total = 0;
			...
			for (Readable r : items) {
				total = total + r.getNumArticles();
			}
			return total;
		}
	
	public void printAllItems () {
		String str = "Items currently at " + name + "\n";
		for (Readable r : items) {
			if (r.isBook() == true) {
				str = str + r.toString() + "\n==========================\n";
			}
